...
public class Activity13_2a {
    ...
    public void writeExcel(String filePath) throws IOException {
        ...
        String[] row1 = {"1", "Hari", "Shah", "hari@example.com", "4537829158"};
        String[] row2 = {"2", "Kishan", "Kati", "kishan@example.com", "4892184058"};
        String[] row3 = {"3", "Grandhe", "Rath", "grandhe@example.com", "4528727830"};
    ...
    public static void main(String args[]) throws IOException {
        ...
        String filePath = "src\\test\\java\\Activities\\Activity13a_output.xlsx";
